...
const verifyConversion = async (req, res) => {
    try {
        ...
        // Check if the team already has an assigned computer character
        if (team && team.animeCharacter && team.animeCharacter.name) {
            return res.status(400).json({
                status: "You have already been assigned a computer character. No further submissions allowed."
            });
        }
